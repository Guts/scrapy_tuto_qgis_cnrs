...
Pour une description de tous les opérateurs et fonctions possibles : voir le [manuel de QGIS](https://docs.qgis.org/latest/fr/docs/user_manual/working_with_vector/expression.html "https://docs.qgis.org/latest/fr/docs/user_manual/working_with_vector/expression.html").

### Faire une requête simple

Ajoutez la couche *[DEPARTEMENT](donnees/TutoQGIS_06_Requetes.zip "donnees/TutoQGIS_06_Requetes.zip")* située dans le dossier **TutoQGIS_06_Requetes/donnees**.
...
![barre d'outils de la table attributaire avec icône sélection entourée en rouge](illustrations/6_1_BO_icone_selection.jpg)
La fenêtre de requête attributaire s'ouvre :

[![fenêtre de sélection, avec une requête simple](illustrations/6_1_selection_fenetre.jpg)](illustrations/6_1_selection_fenetre.jpg "illustrations/6_1_selection_fenetre.jpg")
...
[![carte avec le département du Nord sélectionné](illustrations/6_1_selection_nord.jpg)](illustrations/6_1_selection_nord.jpg "illustrations/6_1_selection_nord.jpg")
...
[![ligne indiquant le nombre d'éléments sélectionnés, en haut de la table et dans la barre d'état](illustrations/6_1_nb_selectionnes.jpg)](illustrations/6_1_nb_selectionnes.jpg "illustrations/6_1_nb_selectionnes.jpg")
...
[![fenêtre pour sauvegarder la sélection](illustrations/6_1_sauv_selection_fenetre.jpg)](illustrations/6_1_sauv_selection_fenetre.jpg "illustrations/6_1_sauv_selection_fenetre.jpg")
...
Par défaut, une nouvelle requête attributaire « part de zéro », en ne tenant pas compte des entités déjà sélectionnées (pour au contraire tenir compte d'une requête précédente, cf. [partie VI.3.1 : Combiner deux requêtes attributaires](06_03_req_combinees.php#VI31 "06_03_req_combinees.php#VI31")).

Néanmoins, pour plus de clarté, il peut être utile de désélectionner des entités.

![icône de désélection](illustrations/6_3_deselection_icone.jpg)Pour désélectionner toutes les entités dans toutes les couches : cliquez sur le bouton **Désélectionner toutes les entités** de la barre d'outils Sélection.
...
Ajoutez la couche *[communes_Bretagne](donnees/TutoQGIS_06_Requetes.zip "donnees/TutoQGIS_06_Requetes.zip")* située dans le dossier **TutoQGIS_06_Requetes/donnees**.
...
![icône de sélection de la table attributaire](illustrations/6_1_selection_attr_icone.jpg)Nous allons faire une requête pour sélectionner les communes de + de 10 000 habitants. Ouvrez la fenêtre de requête pour la couche de communes :

[![fenêtre de sélection avec une requête pour les communes de population supérieure à 10](illustrations/6_1_popsup10000.jpg)](illustrations/6_1_popsup10000.jpg "illustrations/6_1_popsup10000.jpg")
...
[![résultat de la requête pour les communes de population supérieure à 10](illustrations/6_1_popsup10000_res.jpg)](illustrations/6_1_popsup10000_res.jpg "illustrations/6_1_popsup10000_res.jpg")
...
[![liste des opérateurs avec aide pour l'opérateur <>](illustrations/6_1_liste_operateurs.jpg)](illustrations/6_1_liste_operateurs.jpg "illustrations/6_1_liste_operateurs.jpg")
...
[![communes dont le nom commence par PLOU](illustrations/6_1_res_plou.jpg)](illustrations/6_1_res_plou.jpg "illustrations/6_1_res_plou.jpg")
...
![icône de désélection](illustrations/6_3_deselection_icone.jpg)Entre deux requêtes, pour être sûr de repartir à zéro, utiliser l'outil **tout désélectionner**.
...
[![Accès aux requêtes attributaires récentes](illustrations/6_1_requetes_recentes.jpg)](illustrations/6_1_requetes_recentes.jpg "illustrations/6_1_requetes_recentes.jpg")
...
[chapitre précédent](06_00_requetes.php "06_00_requetes.php")
[chapitre suivant](06_02_req_spatiales.php "06_02_req_spatiales.php")
