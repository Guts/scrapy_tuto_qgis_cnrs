...
[![principe d'une jointure attributaire](illustrations/8_1_principe_jointure_attrib.jpg)](illustrations/8_1_principe_jointure_attrib.svg "illustrations/8_1_principe_jointure_attrib.svg")
...
Ouvrez un nouveau projet QGIS et ajoutez-y la couche des régions du [Bhoutan](http://fr.wikipedia.org/wiki/Bhoutan "http://fr.wikipedia.org/wiki/Bhoutan") *[regions_bhutan.shp](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")*.

Ajoutez également au projet la table *[pop_bhutan.csv](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")* : pour cela, procédez comme pour [ajouter une couche de texte délimité](03_03_donnees_XY.php "03_03_donnees_XY.php") en choisissant l'option **Pas de géométrie** :

[![ajout d'un csv : choisir tous les fichiers comme format](illustrations/8_1_ajout_csv.jpg)](illustrations/8_1_ajout_csv.jpg "illustrations/8_1_ajout_csv.jpg")

Vous pouvez également ajouter ce fichier via le [panneau Explorateur](01_02_info_geo.php#I21b "01_02_info_geo.php#I21b") ou en procédant comme pour une couche vecteur.
...
Le [format CSV](http://fr.wikipedia.org/wiki/Comma-separated_values "http://fr.wikipedia.org/wiki/Comma-separated_values") est un format texte contenant des colonnes séparées par un caractère délimiteur, habituellement la virgule, le point-virgule ou la tabulation.

Vous devez donc avoir dans QGIS ces deux données (notez l'icône de tableau pour le CSV) :

![la table et la couche dans la table des matières](illustrations/8_1_donnees_chargees.jpg)
...
[![rubrique jointure des propriétés de la couche](illustrations/8_1_proprietes_jointure.jpg)](illustrations/8_1_proprietes_jointure.jpg "illustrations/8_1_proprietes_jointure.jpg")

Cliquez sur le symbole ![symbole + d'ajout de jointure](illustrations/8_1_plus.jpg) pour ajouter une jointure :

[![création d'une jointure : choix de la couche à joindre et des champs clés](illustrations/8_1_jointure_fenetre.jpg)](illustrations/8_1_jointure_fenetre.jpg "illustrations/8_1_jointure_fenetre.jpg")
...
[![table attributaire de la couche regions_bhutan une fois les données de populations jointes](illustrations/8_1_jointure_res.jpg)](illustrations/8_1_jointure_res.jpg "illustrations/8_1_jointure_res.jpg")
...
Ouvrez un nouveau projet QGIS. Ajoutez-y la couche *gadm36_KEN_1* de la base GeoPackage *[gadm36_KEN.gpkg](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")* et le fichier CSV *[County_Population_2009](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")*.
...
Ouvrez un nouveau projet QGIS. Ajoutez-y les couches *[depts_licences_sportives_2016-2017](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")* et *[depts_CSP_2016](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")*.
...
On peut ensuite explorer la relation entre catégories socio-professionnelles et sports pratiqués, par exemple en utilisant l'extension [Plotly](10_01_representation.php#X14b "10_01_representation.php#X14b") pour visualiser le nombre de licences de golf en fonction de la part de cadres et professions intellectuelles supérieures :

[![graphique du nombre de licences de golf en fonction du % de cadres, réalisé avec Plotly](illustrations/8_1_golf_cadres.jpg)](illustrations/8_1_golf_cadres.jpg "illustrations/8_1_golf_cadres.jpg")

### Si une entité correspond à plusieurs entités de la couche à joindre

#### Pour bien comprendre le problème

Ouvrez un nouveau projet QGIS. Ajoutez-y la couche GeoPackage *[communes_oise](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")* et le fichier CSV *[L_MONUMENT_HISTO_S_060](donnees/TutoQGIS_08_Jointures.zip "donnees/TutoQGIS_08_Jointures.zip")* qui correspond à l'ensemble des monuments historiques classés et inscrits dans le département de l'Oise.
...
[![Emplacement dans la boîte à outils de Statistiques par catégories](illustrations/8_1_stats_cats_emplacement.jpg)](illustrations/8_1_stats_cats_emplacement.jpg "illustrations/8_1_stats_cats_emplacement.jpg")
...
[![Outil Statistiques par catégories](illustrations/8_1_stats_cats_fenetre.jpg)](illustrations/8_1_stats_cats_fenetre.jpg "illustrations/8_1_stats_cats_fenetre.jpg")
...
[![tableau résultat de Statistiques par catégories](illustrations/8_1_stats_cats_res.jpg)](illustrations/8_1_stats_cats_res.jpg "illustrations/8_1_stats_cats_res.jpg")
...
Il ne reste plus qu'à joindre ce tableau à la couche de communes ! Ceci vous permet par exemple de créer une [carte en cercles proportionnels](10_01_representation.php#X11b "10_01_representation.php#X11b") du nombre de monuments par communes :

[![carte en cercles proportionnels du nombre de monuments par commune](illustrations/8_1_carte_monuments_communes.jpg)](illustrations/8_1_carte_monuments_communes.jpg "illustrations/8_1_carte_monuments_communes.jpg")

#### Pour aller plus loin : une deuxième méthode avec une requête SQL

Cette autre méthode fait ici appel à une requête SQL. Une [partie spécifique](06_04_req_sql.php "06_04_req_sql.php") étant dédiée à ces requêtes, voici sans plus de détails une requête répondant à notre question. Pour mieux comprendre cette méthode, si vous n'êtes pas familier du SQL, merci donc de vous reporter [ici](06_04_req_sql.php "06_04_req_sql.php") avant d'aller plus loin !

Vous pouvez bien sûr sauter cette étape et passer directement au [chapitre suivant sur les jointures spatiales](08_02_jointure_spatiale.php "08_02_jointure_spatiale.php").

![icône gestionnaire de bases de données](illustrations/6_4_dbmanager_icone.jpg)Ouvrez la fenêtre du gestionnaire de bases de données : menu **Base de données → DB Manager...**, ou bien cliquez sur l'icône correspondante dans la barre d'outils Base de données.
...
[![dans le gestionnaire de bases de données, requête SQL pour compter le nombre de nombre de monuments par commune](illustrations/8_1_requete_sql.jpg)](illustrations/8_1_requete_sql.jpg "illustrations/8_1_requete_sql.jpg")
...
[chapitre précédent](08_00_jointures.php "08_00_jointures.php")
[chapitre suivant](08_02_jointure_spatiale.php "08_02_jointure_spatiale.php")
