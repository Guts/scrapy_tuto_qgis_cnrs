...
[![fichiers format SIG](illustrations/1_3_fichiers.jpg)](illustrations/1_3_fichiers.jpg "illustrations/1_3_fichiers.jpg")
...
[![fichiers format shapefile](illustrations/1_3_fichiers_shp.jpg)](illustrations/1_3_fichiers_shp.jpg "illustrations/1_3_fichiers_shp.jpg")

La couche *DEPARTEMENT_BRETAGNE* est au format **shapefile** ou **SHP**.
...
Outre le fait d'être constitué de plusieurs fichiers, le format Shapefile possède plusieurs limitations : les noms de colonnes sont limités à 10 caractères et doivent éviter les accents (limites dues à l'utilisation du format DBF), la taille est limitée à 2Go... Pour en savoir plus sur ces aspects, et pour connaître des formats alternatifs : [Switch from Shapefile](http://switchfromshapefile.org/ "http://switchfromshapefile.org/").

#### Format GPKG (GeoPackage)

[![fichiers format geopackage](illustrations/1_3_fichiers_gpkg.jpg)](illustrations/1_3_fichiers_gpkg.jpg "illustrations/1_3_fichiers_gpkg.jpg")

[![fichiers format geopackage (suite)](illustrations/1_3_fichiers_gpkg_2.jpg)](illustrations/1_3_fichiers_gpkg_2.jpg "illustrations/1_3_fichiers_gpkg_2.jpg")

Les 4 couches *LA_DEPARTEMENT*, *LA_LOCALITE_P*, *LA_REGION_S* et *TR_SEGMENT_ROUTIER_L* sont au format GeoPackage ou GPKG.
...
Pour en savoir plus : [https://fr.wikipedia.org/wiki/Geopackage](https://fr.wikipedia.org/wiki/Geopackage "https://fr.wikipedia.org/wiki/Geopackage") (en français) ou [http://switchfromshapefile.org/#geopackage](http://switchfromshapefile.org/#geopackage "http://switchfromshapefile.org/#geopackage") (en anglais).

#### Format TAB (MapInfo)

[![fichiers format TAB](illustrations/1_3_fichiers_tab.jpg)](illustrations/1_3_fichiers_tab.jpg "illustrations/1_3_fichiers_tab.jpg")
...
[![fichiers format TIF](illustrations/1_3_fichiers_tif.jpg)](illustrations/1_3_fichiers_tif.jpg "illustrations/1_3_fichiers_tif.jpg")

La couche *srtm_bretagne* est au format TIF.
...
L'extension du fichier reste TIF. Cependant, chargé dans un logiciel SIG, ce TIF s'affichera directement au bon endroit ; on dit qu'il est **géoréférencé** (cf. [partie 4 sur le géoréférencement](04_00_georeferencement.php "04_00_georeferencement.php")).
...
[chapitre précédent](01_02_info_geo.php "01_02_info_geo.php")
[chapitre suivant](01_04_projets.php "01_04_projets.php")
