...
[![Organisation sous forme de couches](illustrations/1_1_couches.svg)](illustrations/1_1_couches.svg "illustrations/1_1_couches.svg")
Source : pôle ARD, adess (domaine public)

![icône ouvrir un projet](illustrations/1_1_ouvrir_projet_icone.jpg)Lancez le logiciel QGIS. Ouvrez un projet :

[Menu Projet → Ouvrir

![Menu Projet, Ouvrir](illustrations/1_1_ouvrir_projet.jpg)](#thumb "#thumb")

Sélectionnez le projet *senegal.qgz* situé dans **TutoQIS_01_PriseEnMain/projets**, cliquez sur **Ouvrir**.

Trois couches de données sont affichées dans QGIS, correspondant aux villes, rivières et régions du Sénégal.

Ces données proviennent de [l'Agence Nationale de l'Aménagement du Territoire (ANAT) du Sénégal](http://www.anat.sn/ "http://www.anat.sn/") et sont disponibles sur [GéoSénégal](https://www.geosenegal.gouv.sn/Senegal-vectoriel.html "https://www.geosenegal.gouv.sn/Senegal-vectoriel.html"), comme vous pouvez le voir dans la liste des données fournie avec les données du tutoriel (fichier PDF TutoQGIS_01_PriseEnMain_liste_donnees).

#### Deux grands types de données : vecteur et raster

On distingue généralement deux types de données : **vecteur et raster**.

[![Exemple de données vecteur](illustrations/1_1_vecteur.jpg)](illustrations/1_1_vecteur.jpg "illustrations/1_1_vecteur.jpg")
...
[![Données raster](illustrations/1_1_raster.jpg)](illustrations/1_1_raster.jpg "illustrations/1_1_raster.jpg")
Exemple de données raster (source : IGN).

Quelques exemples de formats raster : JPG, TIFF, PNG...

Certains formats, comme le [GeoPackage](https://www.geopackage.org/ "https://www.geopackage.org/"), peuvent contenir des données vecteur ou raster.
...
[![Composantes spatiales et attributaires](illustrations/1_1_spatial_attrib.jpg)](illustrations/1_1_spatial_attrib.jpg "illustrations/1_1_spatial_attrib.jpg")
...
![icône ouvrir un projet](illustrations/1_1_ouvrir_projet_icone.jpg)Ouvrez le projet
 *depts_france.qgz* qui se trouve situé dans le dossier **TutoQIS_01_PriseEnMain/projets**.

![icône ouvrir la table d'attributs](illustrations/1_1_ouvrir_table_icone.jpg)Ouvrez la table attributaire de la couche de départements :

[Clic droit sur le nom de la couche → Ouvrir la table d'attributs

![Clic droit sur la couche, ouvrir la table d'attributs](illustrations/1_1_ouvrir_table.jpg)](#thumb "#thumb")
...
![icône zoom sur la sélection](illustrations/1_1_zoom_selection_icone.jpg) Vous pouvez ensuite cliquer sur l'outil **zoom sur la sélection** pour zoomer sur ce département.

![icône outil de sélection](illustrations/1_1_selection_icone.jpg)Vous pouvez maintenant faire l'inverse : sélectionner un département sur la carte, au moyen de l'outil de sélection. La ligne correspondante passe alors en surbrillance dans la table attributaire.
...
[![Table attributaire : ne montrer que les entités sélectionnées](illustrations/1_1_table_liste_deroulante.jpg)](illustrations/1_1_table_liste_deroulante.jpg "illustrations/1_1_table_liste_deroulante.jpg")
...
Vous pouvez voir ici les métadonnées de la couche Corine Land Cover : [www.geocatalogue.fr/Detail.do?id=7665](http://www.geocatalogue.fr/Detail.do?id=7665 "http://www.geocatalogue.fr/Detail.do?id=7665")
...
La métadonnée ci-dessus est tirée du catalogue de métadonnées national, le géocatalogue : [www.geocatalogue.fr](http://www.geocatalogue.fr/ "http://www.geocatalogue.fr/").

Le géocatalogue est mis en oeuvre par le [BRGM](http://www.brgm.fr/ "http://www.brgm.fr/"), la visualisation étant opérée par l'[IGN](http://www.ign.fr/ "http://www.ign.fr/") au travers du [géoportail](http://www.geoportail.gouv.fr/ "http://www.geoportail.gouv.fr/").
...
Les données nécessaires seront une couche contenant les parcelles de vignes, et un [Modèle Numérique de Terrain (MNT)](http://fr.wikipedia.org/wiki/Mod%C3%A8le_num%C3%A9rique_de_terrain "http://fr.wikipedia.org/wiki/Mod%C3%A8le_num%C3%A9rique_de_terrain") de la zone d'étude. La résolution du MNT devra être suffisante en comparaison de la taille moyenne des parcelles.
...
[chapitre suivant](01_02_info_geo.php "01_02_info_geo.php")
