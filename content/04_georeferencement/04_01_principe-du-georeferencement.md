...
**Le géoréférencement, ou calage, consiste à attribuer des coordonnées à une image**. Cette image pourra ensuite être superposée à d'autres couches dans un logiciel SIG, et servir par exemple de fond de carte ou être [numérisée](05_00_numerisation.php "05_00_numerisation.php"). Nous traiterons uniquement du cas des données raster (il existe d'autres méthodes pour les données vecteur qui ne seront pas abordées ici).
...
[![calage grâce à un carroyage avec coordonnées](illustrations/4_1_calage_methode1.jpg)](illustrations/4_1_calage_methode1.jpg "illustrations/4_1_calage_methode1.jpg")
Calage grâce à un carroyage avec amorces de coordonnées (Source de l'image : [Wikimedia](http://commons.wikimedia.org/wiki/File%3A1902_Land_Office_Map_of_the_Island_of_Oahu%2C_Hawaii_(_Honolulu_)_-_Geographicus_-_OhauHawaii-lo-1902.jpg "http://commons.wikimedia.org/wiki/File%3A1902_Land_Office_Map_of_the_Island_of_Oahu%2C_Hawaii_(_Honolulu_)_-_Geographicus_-_OhauHawaii-lo-1902.jpg"), domaine public)
...
[![calage grâce à une couche déjà calée servant de référence](illustrations/4_1_calage_methode2.svg)](illustrations/4_1_calage_methode2.svg "illustrations/4_1_calage_methode2.svg")
Calage grâce à une couche de référence (Source de l'image à caler : [Wikimedia](http://commons.wikimedia.org/wiki/File:Doncaster_east_locality_map.PNG "http://commons.wikimedia.org/wiki/File:Doncaster_east_locality_map.PNG"), domaine public, source des données de référence [OpenStreetMap](http://www.openstreetmap.org/#map=14/-37.7762/145.1778 "http://www.openstreetmap.org/#map=14/-37.7762/145.1778") © les contributeurs d’OpenStreetMap).

Dans l'illustration ci-dessus, l'image de gauche est géoréférencée en utilisant le fond de carte [OpenStreetMap](http://www.openstreetmap.org/ "http://www.openstreetmap.org/"). Des points que l'on peut facilement identifier sur les deux images (par exemple des intersections de routes) servent de points de calage.

[chapitre précédent](04_00_georeferencement.php "04_00_georeferencement.php")
[chapitre suivant](04_02_preliminaires.php "04_02_preliminaires.php")
